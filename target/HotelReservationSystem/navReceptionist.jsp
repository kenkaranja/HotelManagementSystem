    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="ReceptionistHomePage.jsp">Home</a></li>
                <li><a href="AddRoom">Add Room</a></li>
                <li><a href="ViewRoom">View Room</a></li>
                <li><a href="ViewbookedRooms">View Booked Rooms</a></li>
                <li><a href="ViewCustomer">View Customer</a></li>
                <li style="text-align: right; "><a href="#">
                    <%="welcome: " + session.getAttribute("receptionist")%>
                </a></li>
